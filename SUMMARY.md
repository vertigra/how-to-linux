...
* [Первоначальная настройка Debain-8.0-x86\_64-minimal после исталяции](setting_centos_minimal.md)
...
* [Как управлять iptables](iptables.md)
...
* [Как задать и сбросить параметр other\_config](add_remove_other_config.md)
